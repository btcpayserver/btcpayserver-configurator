...
{
    public static async Task<SshClient> ConnectAsync(this SSHSettings sshSettings,
        CancellationToken cancellationToken = default)
    {
        if (sshSettings == null)
            throw new ArgumentNullException(nameof(sshSettings));
        var tcs =
            new TaskCompletionSource<SshClient>(TaskCreationOptions.RunContinuationsAsynchronously);
        new Thread(() =>
            {
    ...
    public static async Task<string> GetEnvVar(this SshClient sshClient, string name,
    ...
    public static Task<SSHCommandResult> RunBash(this SshClient sshClient, string command,
        TimeSpan? timeout = null)
    {
        if (sshClient == null)
        ...
        var tcs =
            new TaskCompletionSource<SSHCommandResult>(TaskCreationOptions
    ...
    public static async Task DisconnectAsync(this SshClient sshClient,
        CancellationToken cancellationToken = default)
    {
        if (sshClient == null)
            throw new ArgumentNullException(nameof(sshClient));
